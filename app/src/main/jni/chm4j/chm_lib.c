...
//#elif defined(WIN32)  // in comment to build with mingwin  - by Yann D'Isanto on 2008/06/10
#endif                  // to build with mingwin             - by Yann D'Isanto on 2008/06/10
#if defined(WIN32)||defined(_X86_)      // to build with mingwin             - by Yann D'Isanto on 2008/06/10
